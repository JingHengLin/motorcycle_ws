...
--tab -e 'bash -c "sleep 4; source devel/setup.bash; roslaunch motorcycle_gz motorcycle_force.launch"' \
--tab -e 'bash -c "sleep 8; source devel/setup.bash; rosrun  motorcycle_gz velocity_sub"'
